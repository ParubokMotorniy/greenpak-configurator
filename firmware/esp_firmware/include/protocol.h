...
// for now -> reserve 4 most significant bits for the opcode
// the rest 12 bits - for the payload
...
inline CommandRepresentation extractPayload(CommandRepresentation command)
{
    return 0x0FFFu & command;
}
